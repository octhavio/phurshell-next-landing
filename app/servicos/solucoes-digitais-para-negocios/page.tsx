        ...
        <div className="container mx-auto max-w-screen-2xl px-10 sm:px-14 lg:px-20">
          ...
          <div className="mb-12">
            <p className="mb-4 flex items-center gap-3 text-lg font-black uppercase tracking-wider text-brand-orange">
              <i className="fa-jelly fa-suitcase fa-xl"></i>
              Cases de sucesso
            </p>
        ...
        <div className="container mx-auto max-w-screen-2xl px-10 sm:px-14 lg:px-20">
          <div className="mb-8">
            ...
            <p className="max-w-4xl text-xl leading-relaxed text-dark/60">
              Você tem o negócio. Agora você precisa de um parceiro especializado focado em entregar soluções digitais que gerem valor real. Com isso em mente, conduzimos um processo estruturado — do diagnóstico de processos até o suporte contínuo — para garantir que a solução entregue transforme operações e impulsione resultados.
            </p>
          </div>
