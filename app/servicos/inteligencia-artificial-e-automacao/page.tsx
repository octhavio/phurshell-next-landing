...
export default function ServicosIA() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Related Posts */}
      <ServiceRelatedPosts categorySlug="inteligencia-artificial" categoryLabel="inteligência artificial" description="Conteúdos sobre IA, machine learning, automação de processos e como aplicar inteligência artificial para criar vantagens competitivas reais." />
